...
final List<Map<String, dynamic>> menu = [
  {"id": "1", "name": "Egg Tart", "category": "Cakes", "price": 2.40, "image": "assets/cakes/eggTart.png"},
    ...
    { "id": "58", "name": "Sang Suk Nai", "category": "Drinks", "price":2.50, "image": "assets/drinks/sangSukLai.png", "selection":true, "types": [{"name": "Hot", "price": 0.00},{"name": "Cold", "price": 1.00}]},

    { "id": "59", "name": "Teh C Special", "category": "Drinks", "price":4.00, "image": "assets/drinks/tehCSpecial.png", "selection":true, "types": [{"name": "Hot", "price": 0.00},{"name": "Cold", "price": 0.50}]},
    ...
    { "id": "67", "name": "Pandan Soy Milk", "category": "Drinks", "price":3.00, "image": "assets/drinks/pandanSoya.png", "selection":true, "types": [{"name": "with Sugar", "price": 0.00}, {"name": "No Sugar", "price": 0.50}]},
    { "id": "69", "name": "Chinese Teh", "category": "Drinks", "price":0.50, "image": "assets/drinks/chineseTeh.png", "selection":true, "types": [{"name": "Hot", "price": 0.00},{"name": "Cold", "price": 0.00}]},
