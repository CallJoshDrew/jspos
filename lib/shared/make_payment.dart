...
class MakePaymentPageState extends State<MakePaymentPage> {
  ...
  Widget build(BuildContext context) {
    ...
    var statusBarHeight =
        MediaQuery.of(context).padding.top; // Get the status bar height
      ...
      body: Dialog(
        ...
        child: Container(
          ...
          height: screenSize.height -
              statusBarHeight, // Subtract the status bar height from the screen height
          child: Padding(
                            ...
                            children: [
                              ...
                              Expanded(
                                child: ListView.builder(
                                    itemCount: widget
                                        .payment.selectedOrder.items.length,
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          widget
                                              .payment.selectedOrder.totalPrice
                                              .toStringAsFixed(2),
                                          style: const TextStyle(
                                              fontSize: 24,
                                              fontWeight: FontWeight.bold,
